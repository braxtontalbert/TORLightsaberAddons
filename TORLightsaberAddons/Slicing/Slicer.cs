...
namespace TORLightsaberAddons
{
    public sealed class Slicer {
        ...
        public static SlicedHull Slice(GameObject obj, Plane pl, TextureRegion crossRegion, Material crossMaterial) {
            ...
            if (!obj.transform.root.gameObject.TryGetComponentInChildren<MeshFilter>(out var filter)) {
            ...
            if (!obj.transform.root.gameObject.TryGetComponentInChildren<MeshRenderer>(out var renderer)) {
