...
public class CutSimpleConcave : MonoBehaviour
{
    ...
    public void CutMesh(Item slicer, Collision collision)
    {
        //SETUP QUAD VARIABLES==================================================
        planeNormal = slicer.physicBody.angularVelocity.normalized; //cheaper than accessing the normals of the mesh
        planePoint = collision.contacts[0].point; //cheaper than accessing the vertexes of the mesh
        //==================================================

        Mesh targetMesh = target.GetComponentInChildren<MeshFilter>().mesh;
